...
**Origin**: Kirkpatrick, Gelatt, & Vecchi (1983). "Optimization by Simulated Annealing." _Science_ 220(4598), 671-680.
...
**Origin**: Swendsen & Wang (1986). "Replica Monte Carlo simulation of spin-glasses." _Physical Review Letters_ 57(21), 2607.
...
**Origin**: Liu & Wang (2016). "Stein variational gradient descent: A general purpose Bayesian inference algorithm." _NeurIPS_.
...
2. Liu, Q., & Wang, D. (2016). Stein variational gradient descent: A general purpose Bayesian inference algorithm. _NeurIPS_.

3. Swendsen, R. H., & Wang, J. S. (1986). Replica Monte Carlo simulation of spin-glasses. _Physical Review Letters_, 57(21), 2607.

4. Song, Y., & Ermon, S. (2019). Generative modeling by estimating gradients of the data distribution. _NeurIPS_.

5. Rosenbrock, H. H. (1960). An automatic method for finding the greatest or least value of a function. _The Computer Journal_, 3(3), 175-184.

6. Rastrigin, L. A. (1974). Systems of extremal control. _Nauka_.
